...
public sealed class GroupHatching : CustomCardModel
{
    ...
    public static async Task Float(PlayerChoiceContext choiceContext, CardModel source, Player owner, decimal amount)
    {
        ...
        {
            _ = await MinionCmd.AddMinion<FloatingSeaMinion>(choiceContext,owner, new MinionSummonOptions(MaxHp: 8m, PrimaryStatAmount: 2m, Source: source, Position: MinionPosition.Front));
            return;
        }
    ...
    public static async Task Harvest(PlayerChoiceContext choiceContext, CardModel source, Player owner, decimal amount)
    {
        ...
        {
            _ = await MinionCmd.AddMinion<HarvestMinion>(choiceContext,owner, new MinionSummonOptions(MaxHp: 6m, PrimaryStatAmount: 2m, Source: source, Position: MinionPosition.Front));
            return;
        }
