...
public class Attack_Sanity : CustomCardModel
{
    ...
    public Attack_Sanity() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        await PowerCmd.Apply<AttackApplySanityPower>(
            ...
            ((DynamicVar)((CardModel)this).DynamicVars["AttackApplySanityPower"]).BaseValue,
            ((CardModel)this).Owner.Creature,
