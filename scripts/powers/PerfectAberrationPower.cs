...
public sealed class PerfectAberrationPower : CustomPowerModel
{
    ...
    public override string CustomPackedIconPath => "res://Arknights_Mizuki/images/powers/PerfectAberrationPower.png";
