...
public sealed class ColdDisaster : CustomMonsterModel
{
    ...
    public override string CustomVisualPath => "res://Arknights_Mizuki/enemies/cold_disaster/cold_disaster.tscn";
