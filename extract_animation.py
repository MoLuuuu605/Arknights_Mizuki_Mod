...
def extract_frames_from_webm(video_path, output_dir=None, prefix="frame", start_frame=0, end_frame=None, step=1):
    """
...
使用示例:
  ...
  # 组合使用
  python extract_frames.py video.webm -o ./output -p frame -s 100 -e 1000 --step 2
        """
    )
